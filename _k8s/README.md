...
| Directory | Purpose | Install | Prerequisites |
|---|---|---|---|
| [`vault-cluster/`](vault-cluster/README.md) | HashiCorp Vault HA (Raft), 3 nodes, UI/API under `vault.talos.lab.example.io` | `vault-up.sh` | SC `longhorn`; manual unsealing |
