...
| `podSubnets` de Talos == CIDR de l'`IPPool` | sinon kubelet alloue des IP de pod que Calico n'a pas programmées | `grep -A2 podSubnets _out/controlplane.yaml` → `10.244.0.0/16` |
...
- **Dataplane eBPF : tentant, écarté.** Le guide Sidero le recommande, mais il exige
  ...
  `calico_sendmsg_v46`, cf. [siderolabs/talos#12221](https://github.com/siderolabs/talos/issues/12221)).
