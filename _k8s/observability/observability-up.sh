...
sed "s/talos\.lab\.example\.io/${LAB_DOMAIN}/g" "${HERE}/kube-prometheus-stack-values.yaml" > "$KPS_VALUES"
...
sed "s/talos\.lab\.example\.io/${LAB_DOMAIN}/g" "${HERE}/httproutes.yaml" | kubectl apply -f -
