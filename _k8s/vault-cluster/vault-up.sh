...
# Talos, stockage Longhorn, et expose UI/API en HTTPS sous vault.$LAB_DOMAIN.
#
...
# reboot Talos, node down). Ce script redescelle ce qui doit l'être à chaque passage, tant
...
sed "s/talos\.lab\.example\.io/${LAB_DOMAIN}/g" _k8s/vault-cluster/httproute.yaml | kubectl apply -f -
